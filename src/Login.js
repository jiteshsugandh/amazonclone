...
function Login() {
    ...
    const register = e => {
        ...
        .then((auth) => {
            //if created a user successfully
        console.log(auth);
        if (auth) {
            history.push('/')
        }
    ...
    return (
        ...
        <p>
            By signing-in you agree to the Amazon's conditions of the Use & Sale.
